...
BEGIN
	...
	INSERT INTO competencia(nombre, descripcion, nivel_dominio, basico, intermedio, avanzado, tiempoDesarrollo, estado)
	VALUES (in_nombre ,in_descripcion, in_nivel_dominio, in_basico, in_intermedio, in_avanzado, in_tiempoDesarrollo, in_estado);
